...
public class StringBufferConstructors {
	public static void main(String[] args) {
		...
		// 带整型参数的构造方法，创建一个不包含字符、初始容量为10个字符的
		// StringBuffer对象，并把对该对象的引用赋给buffer变量
		StringBuffer buffer2 = new StringBuffer( 10 );
		
		// 带String类型对象参数的构造方法，创建一个包含字符"hello"、
		// 初始容量为21(5+16)个字符的StringBuffer对象，并把对该对象的引用
		// 赋给buffer变量
		...
		//将output添加到对话框中
		JOptionPane.showMessageDialog(null, output,"StringBuffer constuctors",JOptionPane.INFORMATION_MESSAGE);
		//退出系统
		System.exit(0);
	}
